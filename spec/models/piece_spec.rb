...
RSpec.describe Piece, type: :model do
  ...
  #     obstruct = FactoryBot.create(:piece, game: game, column: 2, row: 2, player: player1)
  ...
  #     piece_start = FactoryBot.create(:piece, game: game, column: 1, row: 1, player: player1)
  #     obstruct = FactoryBot.create(:piece, game: game, column: 2, row: 1, player: player1)
  #     obstruction = Pieces::Obstruction.call(piece_start, { column: 3, row: 1 })
  #     expect(obstruction).to eq(true)
  #   end
  # end
  describe 'Capturing a piece' do
    ...
    #   move = piece_start.move(piece_end[:row], piece_end[:column])
